/**
 * This interface defines getter methods for each book's data attributes and is
 * implemented by classes that represent a book and its associated data.
 */
public interface IBook {
	...
	void put(String isbn13, IBook book);
